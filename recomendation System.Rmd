...
There are four way to make recommendation engines(REs):
   ...
   + Personalized recommendation â€? recommend things based on the individualâ€™s past behavior
   + Social recommendation â€? recommend things based on the past behavior of similar users
   + Item recommendation â€? recommend things based on the item itself
